...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname holu) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
#|
...
; La funcion predicado-registro-incompleto recibe como argumento un elemento
; de tipo País y en caso de hallar -1 en el campo poblacion del primer elemento
; de su lista de Registros retornará #false, en caso contrario #true

(check-expect (predicado-registro-incompleto GUATEMALA) #false)
(check-expect (predicado-registro-incompleto ARGENTINA) #true)

(define (predicado-registro-incompleto p)
  (not(= -1 (Registro-Poblacion (first (Pais-Registros p))))))
...
; operacion-sumar-poblaciones: Pais Number -> Number
; La función se encarga de sumar todas las poblaciones actuales
; de una lista de paises
